  ...
  return (
    <>
      <div className="overflow-x-hidden">
        ...
        <div className="pt-32 bg-light_background dark:bg-dark_background flex flex-col">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="py-4 text-5xl text-light_ink dark:text-dark_ink font-bold text-center">
              {t("title")}
            </div>
            <div className="grid grid-cols-3 gap-8 mt-14 text-light_ink dark:text-dark_ink justify-center mx-auto">
              {cardData.map((card, index) => (
                <div key={index} className="flex justify-center">
                  <div className="w-[357px] h-[200px] space-y-2 py-10  bg-light_surface dark:bg-dark_surface rounded-xl flex flex-col text-center justify-center items-center ">
                    <card.Icon size={45} />
