  ...
  return (
    <>
      <div className="pt-24 bg-secondary dark:bg-blackbean flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-x-12 gap-y-12 mt-9 text-blackbean dark:text-secondary">
          {cardData.map((card, index) => (
            <div key={index} className="w-1/3 flex justify-center md:w-1/6">
              <div className="bg-linen dark:bg-falured rounded-xl flex flex-col text-center justify-center items-center p-4 space-y-2">
                <card.Icon size={45} />
