...
const Plans = () => {
  ...
  return (
    <>
      ...
      <div id="pricings" className="pt-24 bg-light_surface dark:bg-dark_surface">
        <motion.div
        ...
        >
          <div className="flex space-x-2 justify-center items-center">
            <div className="text-[34px] text-light_ink dark:text-dark_ink font-bold text-center">
              {t("title")}
            </div>
            <Image
              src={paw}
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 text-light_ink dark:text-dark_ink mx-auto">
            {planData.map((plan, index) => (
              <div
                key={index}
                className="bg-light_background dark:bg-dark_background flex flex-col p-8 rounded-2xl shadow-cards h-full w-[260px]"
              >
                ...
                <div className="flex flex-col mt-[23px]">
                  ...
                  <div className="flex flex-col mt-[23px] text-xs">
                    ...
                    {plan.included && <p className="mt-2">{plan.included}</p>}
