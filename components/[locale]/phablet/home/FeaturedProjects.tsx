    ...
    <>
      ...
      <div id="featuredprojects" className="bg-lightblue dark:bg-darkblue">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="flex flex-col text-dark_ink text-center pt-14">
          ...
          <div className="mt-12">
            <a
              ...
              target="_blank"
              className="bg-light_background text-light_secondary text-base font-bold uppercase px-4 py-2 rounded-full"
            >
              {t("button")}
            </a>
          </div>
