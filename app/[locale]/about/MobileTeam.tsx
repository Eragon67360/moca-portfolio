    ...
    <>
      <div className="font-sans flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col pt-9 justify-between">
          ...
          <div className="border border-light_primary rounded-2xl flex flex-col space-y-3 justify-center items-center py-3 mt-4 px-2 text-xs">
  ...
  return (
    <>
      <div className="h-screen flex flex-col justify-center items-center mx-4">
        <div className="w-full flex flex-col justify-center items-center rounded-3xl p-2 bg-light_surface dark:bg-dark_surface select-none">
