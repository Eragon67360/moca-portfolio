  ...
  return (
    <>
      <div className="flex w-screen bg-light_surface py-[124px]  justify-center items-center">
        <div className="w-[736px] h-full rounded-2xl bg-light_background p-8 shadow-lg space-y-4 ">
          ...
          >
            ...
            <div className="flex space-x-3">
              ...
              <input
                ...
                placeholder="Other"
                type="text"
                className="px-3 border border-light_primary rounded-full dark:bg-light_background"
              />
            </div>
            ...
            <div>
              <DatePicker
                selected={startDate}
                className="px-3 border border-light_primary rounded-full dark:bg-light_background text-light_ink "
            ...
            <textarea
              ...
              rows={5}
              className="h-14 px-3 py-3 border border-light_primary rounded-2xl dark:bg-light_background text-light_ink"
            />
