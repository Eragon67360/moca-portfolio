      ...
      <div className="flex flex-col mt-24 mb-8 mx-12 md:mx-24 lg:mx-32 xl:mx-96 p-24 text-start justify-center bg-secondary dark:bg-linen text-blackbean border border-blackbean rounded-2xl">
        ...
        <ul className="pl-6 mb-4">
          ...
          <li className="mb-2">
            ...
            this Agreement) refers to UX MOCA, 8 rue de Boersch, 67200
            Strasbourg.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>Website</strong> refers to UX MOCA, accessible from{" "}
            <a
              href="uxmoca.com"
        ...
        <h4 className="text-xl font-semibold mb-2">Business Transactions</h4>
        <p className="mb-4">
        ...
        <h4 className="text-xl font-semibold mb-2">Law enforcement</h4>
        <p className="mb-4">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="text-xl font-semibold mb-2">Other legal requirements</h4>
        <p className="mb-4">
        ...
        <h2 className="text-3xl font-semibold mt-4 mb-3">Contact Us</h2>
        <p className="mb-4">
        ...
        <ul className="pl-6 mb-4">
          <li className="mb-2">
            <p>By email: uxmoca@gmail.com</p>
          </li>
          <li className="mb-2">
            <p>
              By visiting this page on our website:{" "}
              <a
                href="uxmoca.com/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                uxmoca.com/contact
